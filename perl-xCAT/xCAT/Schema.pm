...
statelite => {
        ...
        keys => [qw(node)],
                ...
                descriptions => {
                        ...
                        statemnt => 'The persistant read/write area where a node will be written to.  e.g:10.0.0.1/snapshots/.  Do not use the node name as a name as this will be added by default. So in reality, 10.0.0.1:/snapshots, becomes 10.0.0.1:/snapshots/<nodename>',
...
litetree => {
        ...
        descriptions => {
            ...
            directory => 'The hierarchical directory structure where the directory is:  e.g: nfs://xcatmasternode/install/stuff/compute/',
            comments => 'Any user-written notes.',
            disable => "Set to 'yes' or '1' to comment out this row.",
        }
},
